 ...
 *
 * Users with the report/customsqlroles:managecategories capability can enter custom
 *
 * This page shows the list of categories, with edit icons, and an add new button
 * if you have the report/customsqlroles:managecategories capability.
 *
...
admin_externalpage_setup('report_customsqlroles', '', null, '/report/customsqlroles/addcategory.php');
...
$mform = new report_customsqlroles_addcategory_form(report_customsqlroles_url($relativeurl), $queryparams);
...
if ($id) {
    $headstr = get_string('editcategory', 'report_customsqlroles');
} else {
    $headstr = get_string('addcategory', 'report_customsqlroles');
}
