 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_customsqlroles_view_form extends moodleform {
    public function definition() {
        $mform = $this->_form;

        $mform->addElement('header', 'heading', get_string('queryparameters', 'report_customsqlroles'));
        ...
        $this->add_action_buttons(true, get_string('runquery', 'report_customsqlroles'));
    }
}
