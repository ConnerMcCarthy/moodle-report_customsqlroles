...
/**
 * @module report_customsqlroles/reportcategories
 */
define(['jquery'], function($) {
    /**
     * @alias module:report_customsqlroles/reportcategories
     */
    var t = {
        ...
        /**
         * Event handler for expanding or collapsing all sections.
         *
         * @param {Event} e DOM event.
         */
