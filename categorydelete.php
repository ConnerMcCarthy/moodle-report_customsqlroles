...
admin_externalpage_setup('report_customsqlroles', '', ['id' => $id],
        '/report/customsqlroles/categorydelete.php');
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('deletecategoryareyousure', 'report_customsqlroles'));
echo html_writer::tag('p', get_string('categorynamex', 'report_customsqlroles', $category->name ));
echo $OUTPUT->confirm(get_string('deletecategoryyesno', 'report_customsqlroles'),
             new single_button(new moodle_url(report_customsqlroles_url('categorydelete.php'),
