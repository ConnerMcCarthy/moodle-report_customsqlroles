...
/**
 * Lang strings for report/customsqlroles
 *
...
$string['allowedroles_help'] = 'Optionally restrict this query to users who hold one of these system roles. Leave empty to allow any user who already has the required capability.';
$string['anyonewhocanveiwthisreport'] = 'Anyone who can view this report (report/customsqlroles:view)';
...
$string['customsqlroles:definequeries'] = 'Define custom queries';
$string['customsqlroles:managecategories'] = 'Define custom categories';
$string['customsqlroles:view'] = 'View custom queries report';
...
$string['pluginname'] = 'Ad-hoc database queries (role-restricted)';
...
$string['privacy:metadata:reportcustomsqlqueries:categoryid'] = 'The category ID from report_customsqlroles_categories table';
