...
namespace report_customsqlroles\external;
...
class get_users_testcase extends \externallib_advanced_testcase {
    ...
    protected function setup_users(): array {
        ...
        role_change_permission($managerroleid, $context, 'report/customsqlroles:view', CAP_ALLOW);
        role_change_permission($coursecreateorroleid, $context, 'report/customsqlroles:view', CAP_ALLOW);
    ...
    public function test_get_users_customsql_view() {
        ...
        $result = get_users::execute('', 'report/customsqlroles:view');
        $result = \external_api::clean_returnvalue(get_users::execute_returns(), $result);
    ...
    public function test_get_users_serch_without_admins() {
        ...
        $result = get_users::execute('Man', 'report/customsqlroles:view');
        $result = \external_api::clean_returnvalue(get_users::execute_returns(), $result);
    ...
    public function test_get_users_serch_with_admin() {
        ...
        $result = get_users::execute('n U', 'report/customsqlroles:view');
        $result = \external_api::clean_returnvalue(get_users::execute_returns(), $result);
