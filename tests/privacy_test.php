...
/**
 * Unit tests for the report_customsqlroles implementation of the privacy API.
 *
...
use \report_customsqlroles\privacy\provider;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_customsqlroles_privacy_testcase extends \core_privacy\tests\provider_testcase {

    public function setUp(): void {
        $this->resetAfterTest();
        $this->setAdminUser();

        $this->component = 'report_customsqlroles';
    ...
    private function create_customsql_row($userid, $displayname) {
        global $DB;
        $report = new stdClass();
        $time = \report_customsqlroles\utils::time();
