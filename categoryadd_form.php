 ...
 * report/customsqlroles:managecategories capability.
 *
 * @copyright 2013 The Open University
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_customsqlroles_addcategory_form extends moodleform {
    ...
    public function definition() {
        ...
        if ($categoryid) {
            ...
            $strsubmit = get_string('addcategory', 'report_customsqlroles');
        }
