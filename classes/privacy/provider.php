...
/**
 * Privacy Subsystem implementation for report_customsqlroles.
 *
...
namespace report_customsqlroles\privacy;
...
/**
 * Privacy Subsystem for report_customsqlroles implementing null_provider.
 *
 * @copyright  2018 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function export_user_data(request\approved_contextlist $contextlist) {
        ...
        foreach ($contextlist as $context) {
            ...
            if ($context->contextlevel === CONTEXT_SYSTEM) {
                ...
                $subcontext = [
                    get_string('privacy:metadata:reportcustomsqlqueries', 'report_customsqlroles')
                ];
    ...
    protected static function you_or_somebody_else($userid, $user) {
        if ($userid == $user->id) {
            return get_string('privacy_you', 'report_customsqlroles');
        } else {
            return get_string('privacy_somebodyelse', 'report_customsqlroles');
        }
    }
}
