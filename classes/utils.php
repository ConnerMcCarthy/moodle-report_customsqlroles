...
namespace report_customsqlroles;

/**
 * Static utility methods to support the report_customsqlroles module.
 *
...
class utils {
    ...
    public static function time(): int {
        if ((defined('BEHAT_SITE_RUNNING') || PHPUNIT_TEST) &&
                $time = get_config('report_customsqlroles', 'behat_fixed_time')) {
            return $time;
        } else {
            return time();
        }
