...
/**
 * Upgrade code for report_customsqlroles.
 *
 ...
 */
function xmldb_report_customsqlroles_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2012011900) {
        ...
        upgrade_plugin_savepoint(true, 2012011900, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2012092400) {
        ...
        upgrade_plugin_savepoint(true, 2012092400, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2013062300) {
        ...
        upgrade_plugin_savepoint(true, 2013062300, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2013102400) {
        ...
        upgrade_plugin_savepoint(true, 2013102400, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2014020300) {
        ...
        upgrade_plugin_savepoint(true, 2014020300, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2015062900) {
        ...
        upgrade_plugin_savepoint(true, 2015062900, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2016011800) {
        ...
        upgrade_plugin_savepoint(true, 2016011800, 'report', 'customsqlroles');
    }

    if ($oldversion < 2019111101) {
        // For upgraded sites, set this setting to be backwards compatible.
        set_config('startwday', '6', 'report_customsqlroles');
        upgrade_plugin_savepoint(true, 2019111101, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2020102800) {
        ...
        if ($total > 0) {
            ...
            // Now  do the update.
            $progressbar = new progress_bar('report_customsqlroles_emailto_upgrade', 500, true);
            $done = 0;
            foreach ($queries as $query) {
        ...
        // Customsql savepoint reached.
        upgrade_plugin_savepoint(true, 2020102800, 'report', 'customsqlroles');
    }
    ...
    if ($oldversion < 2021051000) {
        ...
        // Customsql savepoint reached.
        upgrade_plugin_savepoint(true, 2021051000, 'report', 'customsqlroles');
    }
